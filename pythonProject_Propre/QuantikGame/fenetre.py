...
class MenuJouer(Screen):
    ...
    def retourMenu(self, event):
        self.parent.current = "principale"
        ...
        if (self.ids["spinnerPieces"].text == "Carré") and (self.joueurQuiAJoue.pieces["carre"] > 0):
            ...
            if acces_joueur1.pseudo == self.joueurQuiAJoue.pseudo:
                if acces_plateau.testVictoire(acces_joueur2.pseudo):
                    self.add_widget(Button(background_normal="QuantikGame/imgs/null.png", background_down="QuantikGame/imgs/null.png",
                               text="Victoire de " + acces_joueur2.pseudo + " !!!", font_size=110,
                               color=(0.1686, 0.5764, 0.2823, 1), on_release=self.retourMenu,markup=True))
                ...
                if acces_plateau.testVictoire(acces_joueur1.pseudo):
                    self.add_widget(Button(background_normal="QuantikGame/imgs/null.png",
                                    background_down="QuantikGame/imgs/null.png",
                                    text="Victoire de " + acces_joueur2.pseudo + " !!!", font_size=110,
                                    color=(0.1686, 0.5764, 0.2823, 1), on_release=self.retourMenu, markup=True))
                    MenuHistorique().ajouterDonnees(acces_joueur1.pseudo, acces_joueur2.pseudo, str(1), str(nb_coups))
            if nb_coups == 16:
                self.add_widget(
                    Button(background_normal="QuantikGame/imgs/null.png", background_down="QuantikGame/imgs/null.png",
                           text="Egalité !!!", font_size=140,
                           color=(0.0117,0.0156,0.3725, 1), on_release=self.retourMenu, markup=True))
            ...
            if acces_joueur1.pseudo == self.joueurQuiAJoue.pseudo:
                if acces_plateau.testVictoire(acces_joueur2.pseudo):
                    self.add_widget(
                        Button(background_normal="QuantikGame/imgs/null.png",
                               background_down="QuantikGame/imgs/null.png",
                               text="Victoire de " + acces_joueur2.pseudo + " !!!", font_size=110,
                               color=(0.1686, 0.5764, 0.2823, 1), on_release=self.retourMenu, markup=True))
                    MenuHistorique().ajouterDonnees(acces_joueur1.pseudo, acces_joueur2.pseudo, str(2), str(nb_coups))
                ...
                if acces_plateau.testVictoire(acces_joueur1.pseudo):
                    self.add_widget(
                        Button(background_normal="QuantikGame/imgs/null.png",
                               background_down="QuantikGame/imgs/null.png",
                               text="Victoire de " + acces_joueur1.pseudo + " !!!", font_size=110,
                               color=(0.1686, 0.5764, 0.2823, 1), on_release=self.retourMenu, markup=True))
                    MenuHistorique().ajouterDonnees(acces_joueur1.pseudo, acces_joueur2.pseudo, str(1), str(nb_coups))
            if nb_coups == 16:
                self.add_widget(
